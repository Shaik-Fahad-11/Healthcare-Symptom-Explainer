...
git clone [https://github.com/your-username/healthcare-symptom-explainer.git](https://github.com/your-username/healthcare-symptom-explainer.git)
...
Logout and Login again. You will see the Admin Dashboard button in the sidebar.
...
Environment Variables: Add your keys from .env to the deployment dashboard.
